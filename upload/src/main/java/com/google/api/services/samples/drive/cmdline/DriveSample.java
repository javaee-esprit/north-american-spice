...
public class DriveSample {
  ...
  private static final String UPLOAD_FILE_PATH = "C://mario.jpg";
  private static final String DIR_FOR_DOWNLOADS = "DownM";
  ...
  public static void driveUpload(InputStream inputStream) {
    ...
    try {
      ...
      File uploadedFile = uploadFile(false, inputStream);
  ...
  private static File uploadFile(boolean useDirectUpload,InputStream inputStream) throws IOException {
    File fileMetadata = new File();
    fileMetadata.setTitle(UPLOAD_FILE.getName()); 

    java.io.File myFile= new java.io.File("tem") ;
//    System.out.println(myFile);
//    System.out.println(inputStream);
    byte[] bytes = IOUtils.toByteArray(inputStream);
    FileUtils.writeByteArrayToFile(myFile,
            bytes);
  
	FileContent mediaContent = new FileContent("image/jpeg", myFile);
